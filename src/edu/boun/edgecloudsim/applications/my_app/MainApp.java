...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/my_app/config/default_config.properties";
			applicationsFile = "scripts/my_app/config/applications.xml";
			edgeDevicesFile = "scripts/my_app/config/edge_devices.xml";
			...
			for(int k=0; k<SS.getSimulationScenarios().length; k++)
			{
				for(int i=0; i<SS.getOrchestratorPolicies().length; i++)
				{
					...
					try
					{
						...
						ScenarioFactory sampleFactory = new CustomScenarioFactory(j,SS.getSimulationTime(), orchestratorPolicy, simScenario);
